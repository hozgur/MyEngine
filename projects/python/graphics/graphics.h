...
class MyPredictor : public myEngine
{
public:
	MyPredictor(const char* path) :myEngine(path)
	{
	...
	const myString project_path = "projects/python/graphics";
	bool status = false;
